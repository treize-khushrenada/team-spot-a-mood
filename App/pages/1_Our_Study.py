...
eval = Image.open(os.path.join(path,'..','assets','model_eval.jpg'))
...
# model evaluation result image
st.image(eval, caption='Model Evaluation')

# results of our model evaluation
with open(os.path.join(path,'eval.md')) as f:
